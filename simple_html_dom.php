...
function file_get_html($url, $use_include_path = false, $context = NULL, $offset = -1
	, $maxLen = -1, $lowercase = true, $forceTagsClosed = true, $target_charset = DEFAULT_TARGET_CHARSET
...
class simple_html_dom {
	...
	protected function parse_attr($node, $name, &$space) {
		...
		if(isset($node->attr[$name])) return;
